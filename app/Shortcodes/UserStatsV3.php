...
class UserStatsV3
{
	public $tag = 'aspen_user_stats_v3';

	public function __construct()
	{
		add_shortcode($this->tag, [$this, 'shortcode']);
		add_action('wp_ajax_user_stats_v3', [$this, 'user_stats_ajax']);
	}

	public function shortcode()
	{
		return '<div id="aspen-user-stats-v3"></div>';
	}
	...
	public function user_stats_ajax()
	{
		...
		$query = new UserStatsQuery($period, $pharmacist_id, $data_type);
